    ...
    def get_hyperparameters(self) -> list:
        ...
        return [
            ...
            Boolean(
                "fullgraph",
                default=False,
                meta={"desc": "Whether to discover compilable subgraphs or compile the full input graph."},
            ),
            CategoricalHyperparameter(
                "dynamic",
                choices=[None, True, False],
                default_value=None,
                meta={"desc": "Whether to use dynamic shape tracing or not."},
            ),
            OrdinalHyperparameter(
                "max_kv_cache_size",
                sequence=[100, 200, 400, 512, 800, 1600, 3200, 6400, 12800, 25600, 51200, 102400],
                default_value=400,
                meta={"desc": "The maximum number of new tokens to generate, for LLMs."},
            ),
            OrdinalHyperparameter(
            ...
            Boolean(
                "make_portable",
                meta={
                    "desc": "Whether to make the model compiled model portable or not, "
            ...
            OrdinalHyperparameter(
                ...
                meta={
                    "desc": "Whether to compile the model itself or the module list. "
                    "Compiling the model itself has a longer warmup and could fail in case of graphbreaks "
                    "but could lead to slightly faster compilation. Whereas compiling the "
                    "module list has a shorter warmup and is more robust to graphbreaks but could be slightly slower."
                },
            ),
        ]
